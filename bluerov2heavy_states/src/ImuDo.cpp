...
void bluerov2heavy_states::ImuDoNodelet::ground_truth_callback(
...
void bluerov2heavy_states::ImuDoNodelet::imu_callback(
...
void bluerov2heavy_states::ImuDoNodelet::gps_callback(
...
void bluerov2heavy_states::ImuDoNodelet::main_spin_callback(const ros::TimerEvent& e)
{   
    if(!tracking_start)
    {
...
bool bluerov2heavy_states::ImuDoNodelet::initialization()
{
    if(
...
void bluerov2heavy_states::ImuDoNodelet::EskfProcess()
{
    update_pub.publish(pub_data);

}

bluerov2heavy_states::synced_data bluerov2heavy_states::ImuDoNodelet::SyncMeas()
// reference: VINS-Mono
{
    using namespace std;
...
void bluerov2heavy_states::ImuDoNodelet::ImuPredict()
{
