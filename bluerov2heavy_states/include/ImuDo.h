...
namespace bluerov2heavy_states 
{
    ...
    private:
        ...
        virtual void onInit()
        {
            ...
            gt_sub = nh.subscribe<nav_msgs::Odometry>
                        ("/bluerov2heavy/pose_gt", 1, &ImuDoNodelet::ground_truth_callback, this);
            
            imu_sub = nh.subscribe<sensor_msgs::Imu>
                        ("/bluerov2heavy/imu", 1, &ImuDoNodelet::imu_callback, this);
            
            gps_sub = nh.subscribe<sensor_msgs::NavSatFix>
                        ("/bluerov2heavy/gps", 1, &ImuDoNodelet::gps_callback, this);
    ...
    PLUGINLIB_EXPORT_CLASS(bluerov2heavy_states::ImuDoNodelet, nodelet::Nodelet)
}
