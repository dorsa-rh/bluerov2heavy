...
class ROV_MPCController():
    ...
    def __init__(self):
        ...
        self._local_planner = LocalPlanner(
            ...
            thrusters_only=True)
        # Publisher
        self._reference_pub = rospy.Publisher('/bluerov2heavy/mpc/reference',
                                              TrajectoryPoint,
                                              queue_size=1)
        #self._error_pub = rospy.Publisher('/bluerov2/mpc/error',
        #                                  TrajectoryPoint, queue_size=1)
        print("bluerov2heavy initialized!")
    ...
    def receive_reference(self):
        ...
        # Subscriber
        rospy.Subscriber("/bluerov2heavy/pose_gt", Odometry, self.pos_callback)
