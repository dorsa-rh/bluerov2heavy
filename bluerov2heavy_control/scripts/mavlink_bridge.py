...
class bluerov2heavy_mavlink():
    ...
    def arm_disarm_vehicle(self,arm):
        ...
        if arm == 0:
            ...
            print("BlueROV2heavy Disarmed!")
        elif arm == 1:
            print("Waiting for the vehicle to arm")
            self.master.motors_armed_wait()
            print('BlueROV2heavy Armed!')
...
if __name__ == '__main__':
    bluerov2heavy = bluerov2heavy_mavlink()
    #bluerov2heavy.set_servo_pwm(1,1700)
    #bluerov2heavy.arm_disarm_vehicle(1)

    for us in range(1100, 1900, 50):
        bluerov2heavy.set_servo_pwm(1, us)
        time.sleep(0.125)
        print("set pwm:",us)

    #bluerov2heavy.request_parameter()
    #bluerov2heavy.arm_disarm_vehicle(0)
